          ...
          <div class="row">
              <div class="col-lg-12">
                  <div class="breadcrumb-text">
                      ...
                      <a href="<?php echo site_url('adminfont/courseadmin'); ?>"><span>Cousre</span></a>
                  ...
                  <div class="blog-details-inner">
                      ...
                      <div>
                          <form action="#" class="comment-form">
                              <div class="row">
                                <a class="site-btn" href="<?php echo site_url('adminfont/recourseadmin/').$rowshow->course_id; ?>">Register Course</a>
                              </div>
                          </form>
                          </div>
                      </div>
