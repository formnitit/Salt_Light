                        ...
                        <div class="recent-post">
                            ...
                            <div class="recent-blog">
                              <?php foreach ($query as $row) {?>
                                <a href="<?php echo site_url('adminfont/proadmin_details/').$row->promotion_id; ?>" class="rb-item">
                                    <div class="rb-pic">
                      ...
                      <?php foreach ($query as $row) {?>
                        <div class="col-lg-6 col-sm-6">
                            <div class="blog-item">
                                ...
                                <div class="bi-text">
                                    <a href="<?php echo site_url('adminfont/proadmin_details/').$row->promotion_id; ?>">
