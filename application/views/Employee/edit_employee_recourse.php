        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url('Employee/edit_recourse_employ1'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="recourse_phone" class="control-label mb-1">อีเมล</label>
                              ...
                              <div align="center">
                                ...
                                <a href="<?php echo site_url('employee_recourse'); ?>">
