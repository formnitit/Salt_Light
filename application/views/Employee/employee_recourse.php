                        ...
                        <td>
                            <div class="table-data-feature">
                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                    <a href="<?php echo site_url('Employee/edit_recourse_employ/').$row->recourse_id; ?>"><i class="zmdi zmdi-edit"></i>
                                </button>
                                <button  class="item" data-toggle="tooltip" data-placement="top" title="Delete" onclick="myFunction()">
                                      <a href="<?php echo site_url('Employee/del_recourse_employ/').$row->recourse_id;?>" </a><i class="zmdi zmdi-delete"></i>
                                      <p id="demo"></p>
                                </button>
                            </div>
                        </td>
