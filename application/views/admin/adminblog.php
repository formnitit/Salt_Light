...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="table-data__tool">
          <h3 class="title-5 m-b-35">ข้อมูลบทความ</h3>
            ...
            <div class="table-data__tool-right">
              <a href="<?php echo site_url('adminaddblog')?>">
                        ...
                        <td>
                            <div class="table-data-feature">
                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                    <a href="<?php echo site_url('adminblog/edit/').$row->blog_id; ?>"><i class="zmdi zmdi-edit"></i>
                                </button>
                                <button  class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                      <a href="<?php echo site_url('adminblog/delete/').$row->blog_id;?>" onclick="return confirm('confirm to delete');"><i class="zmdi zmdi-delete"></i></a>
                                </button>
                            </div>
                        </td>
                    </tr>
