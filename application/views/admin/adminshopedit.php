                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo site_url('adminshopedit/edit'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="product_price" name="product_price" type="text" class="form-control" value="<?php echo $rowedit->product_price;?>">
                            </div>
                            <div class="form-group">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea id="product_detail" name="product_detail" rows="9"  class="form-control" ><?php echo $rowedit->product_detail;?></textarea>
                                    <script>
                                        ClassicEditor
