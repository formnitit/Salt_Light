                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo site_url('adminmember/index1'); ?>">จัดการข้อมูลสมาชิก</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('adminaddmember/index1'); ?>">เพิ่มข้อมูลสมาชิก</a>
                                </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo site_url('adminshop/index1'); ?>">จัดการสินค้า</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('adminaddshop/index1'); ?>">เพิ่มข้อมูลสินค้า</a>
                                </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo site_url('adminblog/index1'); ?>">จัดการข้อมูลบทความ</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('adminaddblog/index1'); ?>">เพิ่มข้อมูลบทความ</a>
                                </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo site_url('admincourse/index1'); ?>">จัดการข้อมูลคอร์ส</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('adminaddcourse/index1'); ?>">เพิ่มข้อมูลคอร์ส</a>
                                </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo site_url('adminpromotion/index1'); ?>">จัดการข้อมูลโปรโมชั่น</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('adminaddpromotion/index1'); ?>">เพิ่มข้อมูลโปรโมชั่น</a>
                                </li>
                        ...
                        <li>
                            <a href="map.html">
                                ...
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                    <li>
                                        <a href="<?php echo site_url('admincontact/index1'); ?>">ข้อมูลติดต่อ</a>
                                    </li>
                                </ul>
                        </li>
