...
<!-- Vendor JS       -->
<script src="<?php echo base_url('assets/admin/vendor/slick'); ?>/slick.min.js"></script>
...
<script src="<?php echo base_url('assets/admin/vendor/bootstrap-progressbar'); ?>/bootstrap-progressbar.min.js"></script>
