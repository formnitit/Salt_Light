            ...
            <div class="col-lg-4">
                <div class="single-banner">
                    ...
                    <div class="inner-text">
                        <a href="<?php echo site_url('shop/index1'); ?>"><h4>Coffee Drink</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="single-banner">
                    ...
                    <div class="inner-text">
                        <a href="<?php echo site_url('shopcoffeebeans/index1'); ?>"><h4>Coffee Beans</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="single-banner">
                    ...
                    <div class="inner-text">
                        <a href="<?php echo site_url('shopcoffeeequipment/index1'); ?>"><h4>Coffee Equipment</h4>
                    </div>
                </div>
            </div>
        </div>
