                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">Coffee Bean</div>
                                        <a href="#">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="<?php echo base_url('assets/img/products'); ?>/coffee beans5.png" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="<?php echo base_url('assets/img/products'); ?>/coffee beans6.jpg" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">Coffee Bean</div>
                                        <a href="#">
                                            <h5>Blue Special Blend III (Hama Blend)</h5>
                                        </a>
                                        <div class="product-price">
                                            ฿330.00
                                            <span></span>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="<?php echo base_url('assets/img/products'); ?>/coffee beans7.jpg" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
                                    ...
                                    <div class="pi-text">
                                        <div class="catagory-name">Coffee Bean</div>
                                        <a href="#">
                                            <h5>Blue Special Blend V (Geisha Blend)</h5>
                                        </a>
                                        <div class="product-price">
                                            ฿580.00
                                            <span></span>
